...
- **ONLY modify:** `*_rest.go` (deprecated), add `*_graphql.go`, `gid.go`, `graphql_client.go`. Tests written in **test directory** `/Users/user/Desktop/ConnectPOS/shopify/unittest` (relative to workspace: `shopify/unittest`), **DO NOT** create _test.go in the main repo.
...
### 6.0 Test Directory (single source of truth)

**Test directory:** `/Users/user/Desktop/ConnectPOS/shopify/unittest` — in workspace this is `shopify/unittest`. All live tests, parity tests, and report generation live here. Do not create `_test.go` in the main repo.

Tests written in this directory:

```
/Users/user/Desktop/ConnectPOS/shopify/unittest
...
```go
// File: shopify/unittest/product/product_parity_test.go (full path: /Users/user/Desktop/ConnectPOS/shopify/unittest/...)
...
```go
// File: shopify/unittest/product/product_cases_test.go
package product_test
...
```bash
cd /Users/user/Desktop/ConnectPOS/shopify/unittest
# Or from workspace: cd shopify/unittest
...
### Tests (Section 6 — test dir: `/Users/user/Desktop/ConnectPOS/shopify/unittest`, workspace `shopify/unittest`)
- [ ] Tests written in test directory `shopify/unittest`, NOT in main repo
- [ ] External tests pass: `cd /Users/user/Desktop/ConnectPOS/shopify/unittest && go test ./... -race`
...
- [ ] Tests written in test directory `/Users/user/Desktop/ConnectPOS/shopify/unittest` (shopify/unittest)
...
Output: `/Users/user/Desktop/ConnectPOS/shopify/unittest/reports/[service]_report.html` (shopify/unittest/reports/)

### 9.1 Report Generator

```go
// File: shopify/unittest/helpers/reporter.go
package helpers
...
```go
// File: shopify/unittest/product/product_report_test.go
...
- Open with: `open /Users/user/Desktop/ConnectPOS/shopify/unittest/reports/ProductService_report.html`
...
- Read test results from: /Users/user/Desktop/ConnectPOS/shopify/unittest/[service]/ (shopify/unittest/[service]/)
- Run the report generation test to collect live parity data
- Generate HTML report to: /Users/user/Desktop/ConnectPOS/shopify/unittest/reports/[service]_report.html
